...
class TestUserModel(BaseTestCase):
    ...
    def test_add_user_duplicate_email(self):
        ...
        self.assertRaises(
            IntegrityError, db.session.commit
        )
    ...
    def test_passwords_are_random(self):
        ...
        self.assertNotEqual(
            user_one.password_hash,
            user_two.password_hash
        )
